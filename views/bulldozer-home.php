<div class="ldp-bulldozer">
    ...
    <main>
        ...
        <div class="ldp-tabs">
            <div class="ldp-tab active" data-tab="#ldp-settings">
                <p class="ldp-tab-icon"><i class="fas fa-cog"></i></p>
                <p class="ldp-tab-title">Settings</p>
            </div>
            <div class="ldp-tab" data-tab="#ldp-theme">
                ...
                <form id="ldp-bulldozer-settings" action="admin-ajax.php" method="post">
                    ...
                    <table>
                        <tr class="ldp-group">
                            ...
                            <td>
                                <label class="switch">
                                    <input id="ldp_bulldozer_enabled"
                        ...
                        <tr class="ldp-group">
                            ...
                            <td>
                                <input type="text" id="ldp_bulldozer_tenor_api_key" value="<?php echo $tenor_api_key ?>"
                                       name="ldp_bulldozer_tenor_api_key">
                                <p class="ldp-help">Enter your API key for <a
                                            href="https://tenor.com/developer/dashboard"
